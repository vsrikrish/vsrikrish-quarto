...
I used Claude Code to port my CV generation workflow to use native Lua/Pandoc/Quarto instead of the Jinja/Python workflow I had hacked together years ago^[This turned out to be pretty complicated given I didn't want to change how I input the data that goes into the CV and I wanted to keep the basic formatting. It also made it straightforward to both render HTML and PDF versions of the CV.]. Otherwise, none of the content on this website or my [lab group's website](https://viveks.bee.cornell.edu) were written, in part or in full, by a generative AI tool (more specifically, large language models, or LLMs).
